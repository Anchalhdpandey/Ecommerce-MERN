  ...
  return (
    <div className="productdisplay">
      ...
      <div className="prodcutdisplay-right">
        ...
        <div className="productdisplay-right-place">
        ...
        <div className="productdisplay-right-description">
          Elevate your casual wardrobe with our Classic Cotton T-Shirt, this versatile top offers all-day
          comfort and a timeless look.
        </div>
